            ...
            <Modal show={openModal} onClose={() => setOpenModal(false)}>
                ...
                <Modal.Body>
                    <div className="space-y-6">
                        ...
                        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            If you have questions for using this app, please consider using this <Link className="text-blue-700 hover:text-blue-900 dark:text-red-300 dark:hover:text-red-100 hover:underline" to="https://github.com/xiaochun-z/ebook-wordwise/wiki" target="_blank">Wiki Page</Link>.
                        </p>
